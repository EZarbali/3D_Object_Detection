...
def show_range_image(frame, lidar_name):
    ...
    img_range = ri_range.astype(np.uint8) # SAME AS IN THE EXERCISE WITH THE RANGE CHANNEL

    # step 5 : map the intensity channel onto an 8-bit scale and normalize with the difference between the 1- and 99-percentile to mitigate the influence of outliers
    ri_intensity = ri[:,:,1]
    # 1 Percentile =  0.0; 99 percentile = 0.511
    ...
    deg90 = int(img_range_intensity.shape[1] / 4) # 360/4 is the right value to divide
